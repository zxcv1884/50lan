                        ...
                        <div class="card-body card-body-color ">
                            ...
                            <div class="order-clone col-sm-7 infov2 fontstyle">
                                <div class="form-group row form-text">
                                    {!! Form::label('type_id', '種類編號(數字)：'),   Form::text('type_id',null,['class'=>'form-control']); !!}
                                </div>
                                <div class="form-group row form-text">
                                    {!! Form::label('drink', '飲料名稱：'),   Form::text('drink',null,['class'=>'form-control']); !!}
                                </div>
                                <div class="form-group row form-text">
                                    {!! Form::label('drink_price', '飲料價格：'),   Form::text('drink_price',null,['class'=>'form-control']); !!}
                                </div>
